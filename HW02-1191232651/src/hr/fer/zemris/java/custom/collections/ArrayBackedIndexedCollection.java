...
/**
 * Provides a custom implementation of a general purpose array. 
 * The array cannot contain null references. No other restrictions are imposed.
 * 
 * @author Erik Banek
 */
public class ArrayBackedIndexedCollection {
	/** 
	 * How many elements are currently in the elements array. 
	 * Those elements have indexes from 0 to size-1 in that array.
	 ...
	 * set and capacity.
	 * The array always starts empty.
	 * @throws IllegalArgumentException if initialCapacity is less than 1, so that
	 * 									array of that size cannot be allocated.
	 */
	 ...
	 * the equals method.
	 * 
	 * @param value of the object that is looked for in the array.
	 ...
	 * 
	 * @param value of the object that is checked.
	...
	/**
	 * Accesses the underlying array with index. If index is out of bounds throws
	 * an exception. Index should be inclusively between zero and size()-1.
	 * 
	 * @param index of the wanted object from the array.
	 ...
	 * 
	 * @param value of the object to be added. Should not be null.
	 * @throws IllegalArgumentException if a null is passed to the method as the 
	 * 									object to be added.
	 */
	...
	/**
	 * Inserts an object at given position in array. Moves all objects that are later
	 * than position in the array one place further in the array.
	 * 
	 * @param value of the object to be added. Should not be null.
	 * @param position where the object should be added. Should not be
	 *        greater than size() or negative.
	 ...
	 * to satisfy the property that all objects are sequentially placed in memory.
	 * If index is not correct, throws an exception.
	 * 
