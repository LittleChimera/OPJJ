...
/**
 * A general, generic stack that contains object references of any type, 
 * adapted from the ArrayBackedIndexedCollection.
 * Null elements are not allowed on the stack.
 * 
 * <p> All operations are O(1), except when the underlying array has to be resized.
 * 
 * @author Erik Banek
 */
public class ObjectStack {
	 ...
	 * @throws EmptyStackException if stack is empty on call.
	 */
	...
	/**
	 * Gets the top object of the stack and removes it from the stack.
	 * Throws an exception if the stack is empty.
	 * 
	 * @return the first object on the stack.
	 * @throws EmptyStackException if stack is empty on call.
	 ...
	 * @throws IllegalArgumentException if user wants to push null object.
	 */
