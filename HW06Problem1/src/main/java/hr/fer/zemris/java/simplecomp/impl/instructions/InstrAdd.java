 ...
 * which adds values of two registers and saves the result to the 3 one. First
 * instruction argument is the register where the result will be stored and on
 * the other two operation is performed.
 * 
 * @author Luka Škugor
 *
 */
public class InstrAdd implements Instruction {
	 ...
	 *             if objects in given registers can't be added.
	 */
	public boolean execute(Computer computer) {
		...
		try {
			...
			throw new ArithmeticException("Only numbers can be added.");
		}
