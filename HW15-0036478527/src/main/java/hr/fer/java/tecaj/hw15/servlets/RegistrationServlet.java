...
/**
 * This servlet is used for registering a new user.
 * 
 * @author Luka Skugor
 *
 */
...
public class RegistrationServlet extends HttpServlet {
	 ...
	 * 
	 * @param user
	 *            data of registering user
	 * @param password
	 *            raw password of registering user
	 * @return list of messages which describe invalidity
	 */
