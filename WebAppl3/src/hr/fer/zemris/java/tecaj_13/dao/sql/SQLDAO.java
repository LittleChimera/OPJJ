 ...
 * konkretna implementacija oèekuje da joj veza stoji na raspolaganju
 * preko {@link SQLConnectionProvider} razreda, što znaèi da bi netko
 * prije no što izvoðenje doðe do ove toèke to trebao tamo postaviti.
 * U web-aplikacijama tipièno rješenje je konfigurirati jedan filter 
 * koji æe presresti pozive servleta i prije toga ovdje ubaciti jednu
